...
function seccTopNavigation() {
    ...
    theUl.append('<li class="noBorder"><a href="/earn-rewards">Rewards</a></li>');
    ...
    theMainUl.append('<li class="noBorder"><a href="/earn-rewards">Rewards</a></li>');
...
function addEmailWarning() {
    var message = "To ensure delivery of email receipts and Southeast Bookstore Rewards add orders@southeastbookstore.org and customerservice@southeastbookstore.org to your address book.";
